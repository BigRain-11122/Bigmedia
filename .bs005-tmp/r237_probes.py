# -*- coding: utf-8 -*-
# R237 three-probe run + window enumeration + scan-side mtimes (R219/R234/R236 conventions)
...
for name, cmd in probes:
    ...
    out.append(txt)
io.open(BS + r'\.bs005-tmp\probe-r237-all.txt', 'w', encoding='utf-8').write('\n'.join(out))

# window enumeration (Biggame master-console watch, R193-R236 line)
import ctypes
...
io.open(BS + r'\.bs005-tmp\windows-R237.txt', 'w', encoding='utf-8').write('\n'.join(titles))
...
io.open(BS + r'\.bs005-tmp\r237-scan.txt', 'w', encoding='utf-8').write('\n'.join(summary))
print('done')
