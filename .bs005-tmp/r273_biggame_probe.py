# -*- coding: utf-8 -*-
# R273: Biggame console window frame probe (panel-expansion watch, D-BS-08
# revival clause). Same as R260-R269 probe: capture WITHOUT focus (R252 F11
...
TITLE = "小游戏公司总控"
FRAME = os.path.join(TMP, "probe-biggame-r273.png")
LOG = os.path.join(TMP, "r273-biggame-probe.txt")
