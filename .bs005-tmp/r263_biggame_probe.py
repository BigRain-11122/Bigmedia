# -*- coding: utf-8 -*-
# R263: Biggame console window frame probe (panel-expansion watch, D-BS-08
# revival clause). Same as R254-R262 probe: capture WITHOUT focus (R252 F11
...
TITLE = "小游戏公司总控"
FRAME = os.path.join(TMP, "probe-biggame-r263.png")
LOG = os.path.join(TMP, "r263-biggame-probe.txt")
