# -*- coding: utf-8 -*-
# R254: Biggame console window frame probe (panel-expansion watch, D-BS-08
# revival clause). Reuses R249 probe geometry (clamped rect). Capture WITHOUT
# focus first to avoid disturbing live desktop (R252 F11 incident lesson);
# focus fallback only if frame looks covered (checked by caller).
import io
import os
import subprocess
import sys
...
TITLE = "小游戏公司总控"
FRAME = os.path.join(TMP, "probe-biggame-r254.png")
LOG = os.path.join(TMP, "r254-biggame-probe.txt")
