# -*- coding: utf-8 -*-
# R274: Biggame console window frame probe (panel-expansion watch, D-BS-08
# revival clause). Same as R260-R273 probe: capture WITHOUT focus (R252 F11
...
TITLE = "小游戏公司总控"
FRAME = os.path.join(TMP, "probe-biggame-r274.png")
LOG = os.path.join(TMP, "r274-biggame-probe.txt")
