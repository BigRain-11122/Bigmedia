# -*- coding: utf-8 -*-
# R267: Biggame console window frame probe (panel-expansion watch, D-BS-08
# revival clause). Same as R260-R266 probe: capture WITHOUT focus (R252 F11
# incident lesson); caller checks whether CEO F11 overlay still covers.
# Copy law: written via write_file UTF-8 channel (R266 encoding lesson).
import io
import os
import subprocess
import sys
...
TITLE = "小游戏公司总控"
FRAME = os.path.join(TMP, "probe-biggame-r267.png")
LOG = os.path.join(TMP, "r267-biggame-probe.txt")

user32 = rs.ctypes.windll.user32
