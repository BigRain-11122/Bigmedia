# -*- coding: utf-8 -*-
# R270: Biggame console window frame probe (panel-expansion watch, D-BS-08
...
TITLE = "小游戏公司总控"
FRAME = os.path.join(TMP, "probe-biggame-r270.png")
LOG = os.path.join(TMP, "r270-biggame-probe.txt")
