# -*- coding: utf-8 -*-
# R266: Biggame console window frame probe (panel-expansion watch, D-BS-08
...
TITLE = "小游戏公司总控"
FRAME = os.path.join(TMP, "probe-biggame-r266.png")
LOG = os.path.join(TMP, "r266-biggame-probe.txt")
