# -*- coding: utf-8 -*-
# R260: Biggame console window frame probe (panel-expansion watch, D-BS-08
# revival clause). Same as R254-R259 probe: capture WITHOUT focus (R252 F11
...
TITLE = "小游戏公司总控"
FRAME = os.path.join(TMP, "probe-biggame-r260.png")
LOG = os.path.join(TMP, "r260-biggame-probe.txt")
