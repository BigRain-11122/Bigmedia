# -*- coding: utf-8 -*-
# R265: Biggame console window frame probe (panel-expansion watch, D-BS-08
# revival clause). Same as R260-R264 probe: capture WITHOUT focus (R252 F11
...
TITLE = "小游戏公司总控"
FRAME = os.path.join(TMP, "probe-biggame-r265.png")
LOG = os.path.join(TMP, "r265-biggame-probe.txt")
