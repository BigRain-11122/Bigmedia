# -*- coding: utf-8 -*-
# R264: Biggame console window frame probe (panel-expansion watch, D-BS-08
# revival clause). Same as R254-R263 probe: capture WITHOUT focus (R252 F11
...
TITLE = "小游戏公司总控"
FRAME = os.path.join(TMP, "probe-biggame-r264.png")
LOG = os.path.join(TMP, "r264-biggame-probe.txt")
