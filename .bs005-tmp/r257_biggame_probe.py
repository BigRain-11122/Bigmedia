# -*- coding: utf-8 -*-
# R257: Biggame console window frame probe (panel-expansion watch, D-BS-08
# revival clause). Same as R255/R256 probe: capture WITHOUT focus (R252 F11
...
TITLE = "小游戏公司总控"
FRAME = os.path.join(TMP, "probe-biggame-r257.png")
LOG = os.path.join(TMP, "r257-biggame-probe.txt")
