# R239 fast-path scan: ledger/decisions anchors, storylines progress, window enum
# ASCII-only script (encoding law); outputs UTF-8 file
import io, os, re, subprocess, sys, ctypes

ROOT = r"C:\Users\sjs20\Desktop\FluxGroup\media\BigStream"
OUT = os.path.join(ROOT, ".bs005-tmp", "r239-scan.txt")
lines = []
...
# 2) Group decisions UTF8 non-empty count (anchor 24, total 27)
...
# 3) storylines progress: novel ch.6? comic ep.3?
