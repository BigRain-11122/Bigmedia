# -*- coding: utf-8 -*-
# R268: Biggame console window frame probe (panel-expansion watch, D-BS-08
# revival clause). Same as R260-R267 probe: capture WITHOUT focus (R252 F11
...
TITLE = "小游戏公司总控"
FRAME = os.path.join(TMP, "probe-biggame-r268.png")
LOG = os.path.join(TMP, "r268-biggame-probe.txt")
