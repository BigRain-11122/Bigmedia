...
6. **开闸 checklist**（O-20260924-1043 审计 F2·升格强制）：①CEO 终审定档（v10/v9 对比）→②口吻改写批（backlog #15·10 封存稿→新声线正典）→③**首件全链走门演练**（S1 编剧官→S2→S3→S4→评审团终审全门实走一件=进链件 ≥9 门槛首战）→④账号批次①就绪→⑤BGM 一句话裁——五项齐=闸开。
