...
| # | 项 | 落点 | 优先 | 状态 |
|---|---|---|---|---|
| C1 | ffmpeg 高级剪辑技能（速度曲线/字幕动态滤镜/转场品质参数） | R-E/R-A 引擎升级备件 | 中 | **学习腿 done 2026-09-25**（R206：`research/ffmpeg-editing-craft-v1.md`——速度曲线 PoC 帧精确实证+工程坑三则+三面技术定谳；**引擎集成腿拆细在案 §4**·下批生产件前认领·素材窗解锁优先序不变）；**集成腿 R315 腿 1+2 毕**（引擎+单测+真渲染冒烟）·**腿 3-4 待领**（bs-001 douyin 试点重渲+层 1.8 复跑+ramp 窗连续性验图+台账四件） |
