# -*- coding: utf-8 -*-
"""R186 ledger append part 2: backlog (fixed anchor), status-export, state.json.
Part 1 (station-reviews + bs004 README) already applied - do not re-run."""
import io
import json
...
anchor4 = "随 F-004 扩至四件]**"
assert t.count(anchor4) == 1, "anchor4 not unique"
note4 = (
...
assert t.count(anchor23) == 1, "anchor23 not unique"
ext23 = (
