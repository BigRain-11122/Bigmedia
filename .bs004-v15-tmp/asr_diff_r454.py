# R454 ASR noise quantifier for bs-004-v15 (char-level diff, subs.srt vs asr-check)
import io, difflib
...
src = flat(r'.bs004-v15-tmp/subs.srt')
asr = flat(r'.bs004-v15-tmp/asr-check.srt')
...
io.open(r'.bs004-v15-tmp/asr-diff-r454.txt', 'w', encoding='utf-8').write('\n'.join(out))
print('sites=%d diff_chars=%d src_len=%d' % (len(ops), diffchars, len(src)))
