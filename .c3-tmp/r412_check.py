# -*- coding: utf-8 -*-
# R412 fast-path five-check (r359_check.py pattern) + three probes (r405 pattern)
...
out_path = os.path.join(repo, ".c3-tmp", "r412_probe.txt")
...
with io.open(os.path.join(repo, ".c3-tmp", "r412_check.txt"), "w", encoding="utf-8") as f:
    f.write("\n".join(L) + "\n")
print("check_file=.c3-tmp/r412_check.txt")
