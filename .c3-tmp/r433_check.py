# -*- coding: utf-8 -*-
# r433 five-check (r432_check.py pattern, HEAD anchor 7c23b15=R432 close commit) + three probes
# round focus: quick-path judgment after R432 (#70 slice-1 delivered; slice-2 cadence not due)
...
out_path = os.path.join(repo, ".c3-tmp", "r433_probe.txt")
...
with io.open(os.path.join(repo, ".c3-tmp", "r433_check.txt"), "w", encoding="utf-8") as f:
    f.write("\n".join(L) + "\n")
print("check_file=.c3-tmp/r433_check.txt")
