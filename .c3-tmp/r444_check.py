# -*- coding: utf-8 -*-
# R444 five-check evidence (r442 pattern + D-20260927-05(2) adoption: full orders scan
# with edit detection for existing order files, per group decision on scan-window blind spots)
import os, io, glob, datetime

R = r'C:\Users\sjs20\Desktop\FluxGroup\media\BigStream'
G = r'C:\Users\sjs20\Desktop\FluxGroup'

# 1) orders full-file scan (D-20260927-05(2) adoption):
#    a) any NEW order file by name-anchor comparison (legacy check kept)
#    b) any EDITED existing order file: mtime newer than anchor file, name <= anchor
...
# 4) daily brief today (09-27, produced by R443) in place -> no rerun
...
# 6) ledger @ five-mode count + decisions non-empty lines (group anchors; utf-8-sig canonical)
