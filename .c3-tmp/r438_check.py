# -*- coding: utf-8 -*-
# r438 five-check (r437_check.py pattern, HEAD anchor 7c23b15=R432 close commit, window R433-R438 uncommitted; this round = window 6/6 -> batch commit R433-R438)
...
out_path = os.path.join(repo, ".c3-tmp", "r438_probe.txt")
...
with io.open(os.path.join(repo, ".c3-tmp", "r438_check.txt"), "w", encoding="utf-8") as f:
    f.write("\n".join(L) + "\n")
print("check_file=.c3-tmp/r438_check.txt")
