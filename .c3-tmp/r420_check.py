# -*- coding: utf-8 -*-
# r420 fast-path five-check (r419_check.py pattern) + three probes
...
# 0b) bm-a insert commits after 6e9d41f (R419 anchor)
...
out_path = os.path.join(repo, ".c3-tmp", "r420_probe.txt")
...
with io.open(os.path.join(repo, ".c3-tmp", "r420_check.txt"), "w", encoding="utf-8") as f:
    f.write("\n".join(L) + "\n")
print("check_file=.c3-tmp/r420_check.txt")
