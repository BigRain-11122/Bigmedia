# -*- coding: utf-8 -*-
# r435 five-check (r434_check.py pattern, HEAD anchor 7c23b15=R432 close commit, window R433-R438 uncommitted)
# round focus per state: quick-path judgment; #70 slice-2 cadence not due (per R433/R434 ruling, due <=09-29 21:40)
...
out_path = os.path.join(repo, ".c3-tmp", "r435_probe.txt")
...
with io.open(os.path.join(repo, ".c3-tmp", "r435_check.txt"), "w", encoding="utf-8") as f:
    f.write("\n".join(L) + "\n")
print("check_file=.c3-tmp/r435_check.txt")
