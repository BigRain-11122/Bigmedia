# -*- coding: utf-8 -*-
# R367 probe runner (read-only): run board/readiness/loop_health, capture output to r367_probe.txt
# children forced to UTF-8 stdout via PYTHONUTF8 to avoid GBK console/pipe mojibake
import subprocess, io, os

repo = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))
os.chdir(repo)
env = dict(os.environ, PYTHONUTF8="1")
out_path = os.path.join(repo, ".c3-tmp", "r367_probe.txt")
