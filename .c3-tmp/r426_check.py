# -*- coding: utf-8 -*-
# r426 fast-path five-check (r425_check.py pattern) + three probes
...
# 0b) bm-a insert commits after 08812b3 (R425 anomaly-close anchor)
...
out_path = os.path.join(repo, ".c3-tmp", "r426_probe.txt")
...
with io.open(os.path.join(repo, ".c3-tmp", "r426_check.txt"), "w", encoding="utf-8") as f:
    f.write("\n".join(L) + "\n")
print("check_file=.c3-tmp/r426_check.txt")
