# -*- coding: utf-8 -*-
# r434 five-check (r433_check.py pattern, HEAD anchor 7c23b15=R432 close commit) + three probes
# round focus: quick-path judgment after R433 idle-fast (#70 slice-2 cadence not due per R432/R433 ruling)
...
out_path = os.path.join(repo, ".c3-tmp", "r434_probe.txt")
...
with io.open(os.path.join(repo, ".c3-tmp", "r434_check.txt"), "w", encoding="utf-8") as f:
    f.write("\n".join(L) + "\n")
print("check_file=.c3-tmp/r434_check.txt")
