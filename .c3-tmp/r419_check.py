# -*- coding: utf-8 -*-
# r419 fast-path five-check (r418_check.py pattern) + three probes
...
out_path = os.path.join(repo, ".c3-tmp", "r419_probe.txt")
...
with io.open(os.path.join(repo, ".c3-tmp", "r419_check.txt"), "w", encoding="utf-8") as f:
    f.write("\n".join(L) + "\n")
print("check_file=.c3-tmp/r419_check.txt")
