# -*- coding: utf-8 -*-
# r422 fast-path five-check (r421_check.py pattern) + three probes
...
out_path = os.path.join(repo, ".c3-tmp", "r422_probe.txt")
...
with io.open(os.path.join(repo, ".c3-tmp", "r422_check.txt"), "w", encoding="utf-8") as f:
    f.write("\n".join(L) + "\n")
print("check_file=.c3-tmp/r422_check.txt")
