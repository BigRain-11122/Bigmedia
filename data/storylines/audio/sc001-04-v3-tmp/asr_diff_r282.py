# R282 ASR noise quantifier for SC-001-04 v3 (char-level diff, source vs asr-check)
# pattern: sc001-03-v3-tmp/asr_diff_r280.py (R278/R280 quantified precedent)
import io, difflib
...
src = flat(r'data/storylines/audio/SC-001-04-v3.srt')
asr = flat(r'data/storylines/audio/sc001-04-v3-tmp/asr-check.srt')
...
io.open(r'data/storylines/audio/sc001-04-v3-tmp/asr-diff-r282.txt', 'w', encoding='utf-8').write('\n'.join(out))
