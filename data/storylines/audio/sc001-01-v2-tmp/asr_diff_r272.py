# R272 ASR noise quantifier for SC-001-01 v2 (char-level diff, source vs asr-check)
# pattern: sc001-05-v1-tmp/asr_diff_r231.py (R229/R231 quantified precedent)
import io, difflib
...
src = flat(r'data/storylines/audio/SC-001-01-v2.srt')
asr = flat(r'data/storylines/audio/sc001-01-v2-tmp/asr-check.srt')
...
io.open(r'data/storylines/audio/sc001-01-v2-tmp/asr-diff-r272.txt', 'w', encoding='utf-8').write('\n'.join(out))
