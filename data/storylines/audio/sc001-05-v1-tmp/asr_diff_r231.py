# R231 ASR noise quantifier for SC-001-05 (char-level diff, source vs asr-check)
# pattern: sc001-04-v1-tmp/asr_diff_r229.py (R229 quantified precedent)
import io, difflib
...
src = flat(r'data/storylines/audio/SC-001-05-v1.srt')
asr = flat(r'data/storylines/audio/sc001-05-v1-tmp/asr-check.srt')
...
io.open(r'data/storylines/audio/sc001-05-v1-tmp/asr-diff-r231.txt', 'w', encoding='utf-8').write('\n'.join(out))
