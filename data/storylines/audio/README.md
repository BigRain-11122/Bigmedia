...
| SC-001-03-v1.mp3《硅基城市·第三章·周三的棋局》 | 3:10.3（ffprobe 190.26s） | 13 | zh-CN-YunyangNeural+cyber light+human 42（产线默认） | ai_feel 0 FAIL 0 WARN（gaps 12 处 0.220-0.675s varied/pacing CV 0.461/prosody 7 档 13 拍/copy CV 0.509） | 在链（R226 第一程毕·E8 终审听审+ASR 终轨+F-010 登记=下轮） |
