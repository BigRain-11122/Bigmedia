# R278 ASR noise quantifier for SC-001-02 v3 (char-level diff, source vs asr-check)
# pattern: sc001-01-v3-tmp/asr_diff_r276.py (R276 quantified precedent)
import io, difflib
...
src = flat(r'data/storylines/audio/SC-001-02-v3.srt')
asr = flat(r'data/storylines/audio/sc001-02-v3-tmp/asr-check.srt')
...
io.open(r'data/storylines/audio/sc001-02-v3-tmp/asr-diff-r278.txt', 'w', encoding='utf-8').write('\n'.join(out))
