# R276 ASR noise quantifier for SC-001-01 v3 (char-level diff, source vs asr-check)
# pattern: sc001-01-v2-tmp/asr_diff_r272.py (R272 quantified precedent)
import io, difflib
...
src = flat(r'data/storylines/audio/SC-001-01-v3.srt')
asr = flat(r'data/storylines/audio/sc001-01-v3-tmp/asr-check.srt')
...
io.open(r'data/storylines/audio/sc001-01-v3-tmp/asr-diff-r276.txt', 'w', encoding='utf-8').write('\n'.join(out))
