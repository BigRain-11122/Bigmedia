# R229 ASR noise quantifier for SC-001-04 (char-level diff, source vs asr-check)
# pattern: .bs005-tmp/asr_diff_r227.py (R227 quantified precedent)
import io, difflib
...
src = flat(r'data/storylines/audio/SC-001-04-v1.srt')
asr = flat(r'data/storylines/audio/sc001-04-v1-tmp/asr-check.srt')
...
io.open(r'data/storylines/audio/sc001-04-v1-tmp/asr-diff-r229.txt', 'w', encoding='utf-8').write('\n'.join(out))
