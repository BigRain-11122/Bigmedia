...
3. [done 2026-09-23] 选题库-台账一致性探针：校验 ideas.md 状态字段与 data/drafts 文件名前缀一一对应——落地=src/board_check.py（状态流自台账声明动态解析；FAIL 规则=vocab/dup-id/bad-status/drafts-dir/bad-name/orphan/overstate/stale）+ tests/test_board_check.py 11 用例全绿；真板回归 5 题 10 稿 0 FAIL
