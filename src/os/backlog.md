...
1. 为 src/draft_lint.py 写最小测试件 tests/test_draft_lint.py（用临时夹具假稿，勿动 data/drafts 真稿）
2. 建 docs/variant-templates.md——11 平台变体骨架模板（标题/画幅/字数/标签/封面提示规格骨架；模板非内容，不违反生产暂停令）
