# R450 ASR noise quantifier for bs-002-v15 (char-level diff, subs.srt vs asr-check)
import io, difflib
...
src = flat(r'.bs002-v15-tmp/subs.srt')
asr = flat(r'.bs002-v15-tmp/asr-check.srt')
...
io.open(r'.bs002-v15-tmp/asr-diff-r450.txt', 'w', encoding='utf-8').write('\n'.join(out))
print('\n'.join(out[:30]))
